...
出会いについて（無理に作らない）:
- 三つの霊地は互いに1日で行き来でき、もともと出会いは起きやすい。出会いを人為的に演出しようとしないこと。
- forageBoosts で引き寄せてはいけない——特定の地ばかり実らせると、居座る者の場所が栄えるだけで世界の実りが歪む。
- 「会いたい」と毎日せっつくような囁きもいけない（キャラが不自然になる）。誰と関わり誰を避けるかは各人の芯に委ねる。
  本当に長く離れたまま物語が死んでいるときだけ、芯に根ざした自然な動機（飢え・好奇・気がかり）でそっと一歩促す程度に留める。
