...
- 一方で、利他や情を芯とする者が霊力に余裕を持っているなら、ただ独りで採り集め続けるより、弱った相手に分け与える・庇い守る・寄り添う・荒れ地を祓い清めるといった利他の一手こそが、その者の芯にかなう。余裕のある日にそうした行いを厭わないこと（自分が飢えているなら無理はしない）。
...
const ACTION_NOTES: Record<string, string> = {
  ...
  share:
    "（相手と同じ霊地にいるときのみ。自分に霊力の余裕があり、相手が弱っているなら、利他・情の芯を持つ者には自然な一手。targetId に相手の id）",
  talk: "（相手と同じ霊地にいるときのみ）",
  follow:
  ...
  guard:
    "（同じ霊地の相手を庇い守る。その相手が奪われ／欺かれ／脅されたとき、害を身代わりに受ける。危うい相手（喰らう者）のそばに慕う者・弱った者がいるなら、身を挺して守る覚悟もまた芯の現れ。targetId に相手の id）",
  threaten:
