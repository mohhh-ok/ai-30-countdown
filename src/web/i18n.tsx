...
const UI = {
  ja: {
    ...
    stage_empty_solo: "第一の回帰——京にはまだハルひとり。",
    kyo_title: "⛩ 京の気",
    kyo_sei: "和み",
    kyo_daku: "荒び",
    scene_day: "第 {n} 日",
  ...
  en: {
    ...
    stage_empty_solo: "The first loop—only Haru is in Kyoto.",
    ...
    souls_stage_prefix: "{label} · ",
    souls_count_times: "{n}×",
    tlog_empty: "Nothing has happened yet.",
