...
| 祓い清める | `purify` | 自分 −2 / 荒魂を鎮め和魂へ和らげる | 相手不要。結界力を貯める |
...
- 「祓い清める」は相手不要。その地の荒魂を鎮め、一部を和魂へ和らげる。
- 民の霊力は二相に分かれる: **和魂（にぎみたま＝澄んだ和やぎの気。内部 `sei`）／荒魂（あらみたま＝人の欲・念・猛りの気。内部 `daku`）**。荒魂は穢れ・悪ではなく神の猛き面で、鎮めれば和魂へ和らぐ。集霊は和魂を頂き、奪命（喰らう者）は荒魂を好んで喰らう。観客ビューの「京の気」ゲージは各霊地の和魂/荒魂を2本バーで表示する。
